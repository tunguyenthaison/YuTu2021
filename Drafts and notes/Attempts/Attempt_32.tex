...
\paragraph{Step 1.} Using $x\mapsto \Phi(x,y_\sigma)$ has a maximum over $\Omega$ at $x=x_\sigma$, we have
\begin{equation*}
...
\begin{equation*}
    \frac{3C_0|x_\sigma-y_\sigma|(x_\sigma-y_\sigma)}{\sigma} -\frac{A\varepsilon^{3/2}\nabla d(x_\sigma)}{2d(x_\sigma)^{3/2}} \in D^+u^\varepsilon(x_\sigma).
\end{equation*}
and thus
\begin{equation*}
    \left|\frac{3C_0|x_\sigma-y_\sigma|(x_\sigma-y_\sigma)}{\sigma} -\frac{A\varepsilon^{3/2}\nabla d(x_\sigma)}{2d(x_\sigma)^{3/2}}\right| \leq \frac{C\varepsilon^{3/2}}{d(x_\sigma)^{3/2}}
\end{equation*}
and thus 
\begin{equation*}
    |x_\sigma - y_\sigma| \leq \frac{C\sqrt{\sigma}\varepsilon^{3/4}}{d(x_\sigma)^{3/4}}.
\end{equation*}
\paragraph{Step 2.} Using $\Phi(x_\sigma,y_\sigma)\geq \Phi(x_\sigma,(1-\delta)x_\sigma)$ we deduce that
\begin{align*}
    &u^\varepsilon(x_\sigma) - u_\delta(y_\sigma) - \frac{C_0|x_\sigma - y_\sigma|^3}{\sigma} - \frac{C\varepsilon^{3/2}}{d(x_\sigma)^{1/2}}\\
    &\qquad\qquad\qquad \qquad \geq     u^\varepsilon(x_\sigma) - u_\delta((1-\delta)x_\sigma) - \frac{C_0|x_\sigma - (1-\delta)x_\sigma|^3}{\sigma} - \frac{C\varepsilon^{3/2}}{d(x_\sigma)^{1/2}}.
\end{align*}
Therefore
\begin{equation*}
    \frac{C_0|x_\sigma - y_\sigma|^3}{\sigma}  \leq C_0|(1-\delta)x_\sigma - y_\sigma| \leq C_0|x_\sigma - y_\sigma| + C_0\delta|x\sigma|
\end{equation*}
therefore
\begin{align*}
    \frac{|x_\sigma - y_\sigma|21qd [[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[]]][]}{}
\end{align*}
\end{proof} 
