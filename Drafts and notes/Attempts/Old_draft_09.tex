...
\begin{align*}
    \Phi^{\sigma}(x,y) =  u^\varepsilon(x) - u_\delta(y) - \frac{C_0|x-y+\delta \nabla d(x)|^2}{2\sigma^2}- \frac{C_\varepsilon}{d(x)^{\alpha+\beta}}, \qquad (x,y)\in \overline{\Omega}\times\overline{\Omega}_\delta.
\end{align*}
...
\item[2.] The unit outward normal vector at a point $z\in \partial\Omega$ is given by 
\begin{equation*}
    \mathbf{n}(z) = -\nabla d(z).
\end{equation*}
The projection of $x_\sigma$ to $\partial\Omega$ is given by
\begin{equation*}
    \underline{x}_\sigma = x_\sigma + d(x_\sigma)\mathbf{n}(\underline{x}_\sigma).
\end{equation*}
Assume $0<d(x_\sigma) < \delta$, then clearly 
\begin{equation*}
    x_\sigma - \delta \mathbf{n}(\underline{x}_\sigma) \in \overline{\Omega}_\delta.
\end{equation*}
From $\Phi^\sigma(x_\sigma,y_\sigma) \geq \Phi^\sigma(x_\sigma,x_\sigma-\delta \mathbf{n}(\underline{x}_\sigma))$ we have
    \begin{equation}\label{e:est_sigma2}
     \frac{C_0|x_\sigma-y_\sigma - \delta\nabla d(x_\sigma)|^2}{2\sigma^2} \leq u_\delta(x_\sigma) - u_\delta(y_\sigma) \leq C_0|x_\sigma-y_\sigma| \qquad\Longrightarrow\qquad |x_\sigma -y _\sigma|\leq \sigma.
    \end{equation}
    This gives us that
