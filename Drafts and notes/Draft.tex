...
\subsection{Assumptions} We will always assume $\Omega$ is an open, bounded and connected with $\mathrm{C}^2$ boundary in $\mathbb{R}^n$ satisfying either %$H:\mathbb{R}^n\times \mathbb{R}^n$ is a continuous Hamiltonian. 
%\begin{itemize}
