...
%% commentary bubble
\newcommand{\YH}[2][]{\sidenote[colback=green!10]{\textbf{YH\xspace #1:} #2}}
\newcommand{\ST}[2][]{\sidenote[colback=orange!10]{\textbf{ST\xspace #1:} #2}}
%============%============%============%============%
...
Paper to read \cite{Ishii2017a}.

%\nocite{*}

\section{Questions}
\paragraph{Jan 12, 2021.} Why do we use the distance functions to get boundary estimates? 
